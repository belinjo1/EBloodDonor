...
#header{
    ...
    align-items: center;
    background: linear-gradient(120deg, rgba(180,182,205,1) 0%, rgba(204,160,160,1) 100%);
    padding: 15px 0;
...
.header-logo{
    display: flex;
    align-items: center;
    background: rgba(212, 215, 224, 0.7);
    padding: 3px 15px;
    border-radius: 25px;
    align-self: center;
    box-shadow: 0px 0px 11px 0px rgba(0, 0, 0, 0.103);
    transition: 0.2s;
}
