      ...
      <ul>
        ...
        <li>
          <router-link to="/admin/users"
            ><font-awesome-icon :icon="['fas', 'users']" /> Users</router-link
          >
        </li>
        <li>
...
ul a:hover {
  transition: 0.2s;
  background-color: rgba(160, 144, 144, 0.932);
}

.main-links .router-link-exact-active,
.main-links .router-link-exact-active:hover {
