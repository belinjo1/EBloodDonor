<template>
    <div class="main">
        <div class="login">
            <div>
            <img src="../assets/avatar-plus.png" class="profile-image" alt="profile icon">
            <form @submit.prevent="submit">

              <div class="input-label">
              <label for="name"><font-awesome-icon :icon="['fas', 'user']" /> Name</label>
              <input type="text" name="name" v-model="form.name" placeholder="Enter your full name" />
              </div>
              ...
              <div class="input-label">
              <label for="bloodtype"><font-awesome-icon :icon="['fas', 'droplet']" /> Blood Type</label>
              <select name="bloodtype" v-model="form.bloodtype">
                <option disabled>Select blood type</option>
                <option v-for="type in bloodtypes" :value="type">{{type}}</option>
              </select>
              </div>

              <!-- <div class="input-label">
              <label for="city"><font-awesome-icon :icon="['fas', 'envelope']" /> City</label>
              <input type="text" name="city" v-model="form.city" placeholder="Enter your city" />
              </div> -->
              ...
              <div class="input-label">
              <label for="passwordConfirm"><font-awesome-icon :icon="['fas', 'key']" /> Confirm Password</label>
              <input type="password" name="passwordConfirm" v-model="form.passwordConfirm" placeholder="Confirm your password" />
              </div>
